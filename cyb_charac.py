...
class Player(pygame.sprite.Sprite):
	def __init__(self):
		super().__init__()
		player_walk_1 = pygame.image.load('graphics\Player\pwalk1 - Copy.jpg').convert_alpha()
		player_walk_2 = pygame.image.load('graphics\Player\pwalk2.jpg').convert_alpha()
		self.player_walk = [player_walk_1,player_walk_2]
		self.player_index = 0
		self.player_jump = pygame.image.load('graphics\Player\pjump.jpg').convert_alpha()
